...
$toEmail = "hugo.courte@insa-lyon.fr"; // Replace Your Email Address
...
$fromEmail = "hugoco@github.io";  // Replace Company's Email Address (preferably currently used Domain Name)
$fromName = "Website note"; // Replace Company Name
